...
<Project name="전력설비 예방진단 시스템" imgSrc={["img/career/tds_youho.png","img/career/tds_youho2.png"]}>
  ...
  <div class="content">
    ...
    <p class="contents-normal">
      기획 단계 아이디어로 특허 4건을 취득하였고, 과제로 파생 시스템 (예방진단교육 시스템, 예방진단 인증시험 시스템) 개발을 하여 당해 한전정부과제 성과 1, 2위를 달성하였습니다.
    </p>
